...
<template>
    <div>
        ...
        <div class="container">
            ...
            <p style="text-align: justify; color: #734a4a;">El restaurante da inicio a partir del 26 de septiembre de
                2022; donde se encuentra ubicado en el corazón del barrio La Chiquinquirá del municipio del Socorro,
                Santander; el restaurante JuanMar se ha consolidado como un destino imperdible en el Socorro desde su
                apertura hace dos años. Este establecimiento ofrece un ambiente cálido y familiar, ideal para disfrutar
                ...
                resaltan la calidad y el sabor. La infraestructura rústica del restaurante, complementada por un diseño
                ...
                especiales, JuanMar se posiciona como el lugar perfecto para celebrar cualquier ocasión, ya sea una cena
                romántica o una reunión familiar. No esperes más y reserva tu mesa para vivir una experiencia única,
                donde cada visita es una oportunidad para crear recuerdos inolvidables.</p>
            ...
            <div class="mt-5">
                ...
                <p style="text-align: justify; color: #734a4a;">{{ descripcionMision }}</p>
            </div>

            <div class="mt-5">
                <h4 class="mb-3" style="color: #734a4a; font-weight: bold;">Visión</h4>
                <p style="text-align: justify; color: #734a4a;">{{ descripcionVision }}</p>
            </div>
            ...
            <div class="mt-5">
                ...
                <div  v-for="vc in valoresCorporativos" :key="vc._id">
                    <p class="fs-5" style="text-align: justify; color: #734a4a;">
                        ...
                        <span style="text-align: justify; color: #734a4a; margin-left: 10px;"> {{ vc.descripcion }}</span>
                    </p>
                </div>
            </div>
